...
const Enquiry = require('../models/enquiryKhagha');
const { validationResult, body } = require('express-validator');

//ROUTE 1 : Fetch all the Enquiry using: GET "/api/enquiryKhagha/allEnquiry".
...
// ROUTE 2 : Add a new Enquiry using: POST "/api/enquiryKhagha/addEnquiry".
...
//ROUTE 3 : Delete an existing Enquiry using: DELETE "/api/enquiryKhagha/addEnquiry".
